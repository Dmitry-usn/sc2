...
<main class="cite-main">
    ...
    <div class="tours-cards-container">
        <aside class="tours-cards-aside">
            <table class="tours-table">
                ...
                <tr class="tours-table-tr" onclick="tourActive(this)"><td class="tours-table-td" id="tourAll" >Все </td></tr> 
                <tr class="tours-table-tr" onclick="tourActive(this)"><td class="tours-table-td" id="tourNature" >Природа</td></tr>
                <tr class="tours-table-tr" onclick="tourActive(this)"><td class="tours-table-td" id="tourCity" >Город</td></tr>
                <tr class="tours-table-tr" onclick="tourActive(this)"><td class="tours-table-td" id="tourHistorical" >Исторические</td></tr>
        ...
        <div class="tours-cards">
            ...
            //var_dump($_POST['number_of_persons']);
            
            if ($_POST['number_of_persons'] === null) { 
                $_POST['number_of_persons'] = 0;
                //var_dump($_POST['number_of_persons']);
            ...
            if ($_POST['duration'] === null) {
                $_POST['duration'] = 10000;
                //var_dump($_POST['duration']);
            };
            //var_dump($_POST['ex_type']);
            if ($_POST['ex_type'] === null) { $_POST['ex_type'] = 0; };
    ...
    <script>
        ...
        function tourActive(elem) {
            let tableTrArr = document.querySelectorAll('tr.tours-table-tr');

            for (let i = 0; i < tableTrArr.length; i++) {
                tableTrArr[i].classList.remove('tours-table__active');
                elem.classList.add('tours-table__active');
            }
        }
